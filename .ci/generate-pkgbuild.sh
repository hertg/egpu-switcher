...
_source=(egpu-switcher-\$_pkgver.tar.gz::https://github.com/hertg/egpu-switcher/archive/refs/tags/$1.tar.gz)
EOF
...
_pkgver=$(echo $1 | sed 's/\([^-]*-g\)/r\1/;s/-/./g')
_sha256sum=$2
_source=egpu-switcher-bin-\$_pkgver::https://github.com/hertg/egpu-switcher/releases/download/$1/egpu-switcher-amd64
EOF
